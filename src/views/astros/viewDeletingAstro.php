...
<head>
    ...
    <title><?php echo htmlspecialchars("Eliminando: " . $astro->name); ?></title>
    <style>
        body{
...
<p style="font-size: 22.99px; color: #ff0000;"><?php echo htmlspecialchars("Eliminando " . $astro->name); ?></p>
...
<a class="general-link" href="<?php echo BASE_URL."?controller=AstroController&action=viewAstro&id=$astro->id" ?>">Cancelar</a>
<a class="general-link" href="<?php echo BASE_URL."?controller=AstroController&action=deleteAstro&id=$astro->id" ?>">Confirmar</a>
